...
function IvisionLogo({ className = '' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 420 150" role="img" aria-label="IVISION logo" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="ivision-logo-gradient" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#8ff8ff"/><stop offset="0.55" stopColor="#27d9ff"/><stop offset="1" stopColor="#0aa7e8"/></linearGradient>
        <filter id="ivision-logo-glow" x="-60%" y="-60%" width="220%" height="220%"><feGaussianBlur stdDeviation="4" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
      </defs>
      <g transform="translate(8 8)" fill="none" stroke="url(#ivision-logo-gradient)" strokeWidth="8" strokeLinecap="round" filter="url(#ivision-logo-glow)">
